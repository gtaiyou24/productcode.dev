...
export function GridTileProduct({
  ...
  return (
      <Card className="group w-full h-full max-w-sm overflow-hidden rounded-lg border border-secondary text-primary bg-white dark:bg-black hover:border-primary">
